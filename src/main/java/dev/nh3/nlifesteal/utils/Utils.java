package dev.nh3.nlifesteal.utils;
...
public class Utils {
    public static ItemStack setPDC(ItemStack itemStack, String key, PersistentDataType<String, String> persistentDataType, String value){
        ...
        itemMeta.getPersistentDataContainer().set(
                new NamespacedKey(NLifeSteal.getInstance(), key),
                persistentDataType,
                value
        );
    ...
    public static Component translate(String input) {
        return NLifeSteal.getMiniMessage().deserialize(toMiniMessage(input)).decoration(TextDecoration.ITALIC, false);
    }
}
